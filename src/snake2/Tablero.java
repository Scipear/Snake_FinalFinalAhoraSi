...
public class Tablero {
     ...
     * @version 1.1.4
     */
    public void generarComidaEspecial() throws JavaLayerException {
        int posiciones[] = casillaAleatoria();
    ...
    /**
     * Confirma que una casilla este libre, no sea pared ni se encuentre un
     * personaje o comida sobre ella
     *
    ...
    //Metodos encargados de reproducir el sonido de la comida cuan
    ...
    public void conteoComidaEspecial() throws JavaLayerException {
    ...
    /**
     * Si el efecto de rapidez esta activo, entonces se desactiva y vuelve a la
     * velocidad normal
     *
     * @version 1.1.4
     */
